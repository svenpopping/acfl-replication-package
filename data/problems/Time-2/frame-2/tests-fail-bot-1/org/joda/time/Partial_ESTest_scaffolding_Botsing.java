...
public class Partial_ESTest_scaffolding_Botsing {
  @org.junit.Rule 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Partial_ESTest_scaffolding_Botsing.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.DateTimeFieldType", false, Partial_ESTest_scaffolding_Botsing.class.getClassLoader()));
    mock(Class.forName("org.joda.time.DateTimeZone", false, Partial_ESTest_scaffolding_Botsing.class.getClassLoader()));
  }
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Partial_ESTest_scaffolding_Botsing.class.getClassLoader()); 
