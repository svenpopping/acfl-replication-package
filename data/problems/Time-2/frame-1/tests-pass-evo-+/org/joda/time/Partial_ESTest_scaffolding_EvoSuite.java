...
public class Partial_ESTest_scaffolding_EvoSuite {
  @org.junit.Rule 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Partial_ESTest_scaffolding_EvoSuite.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.DateTimeUtils$MillisProvider", false, Partial_ESTest_scaffolding_EvoSuite.class.getClassLoader()));
    mock(Class.forName("org.joda.time.format.DateTimeParser", false, Partial_ESTest_scaffolding_EvoSuite.class.getClassLoader()));
    mock(Class.forName("org.joda.time.format.DateTimePrinter", false, Partial_ESTest_scaffolding_EvoSuite.class.getClassLoader()));
  }
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Partial_ESTest_scaffolding_EvoSuite.class.getClassLoader()); 
