...
public class Period_ESTest_scaffolding_EvoSuite {
  @org.junit.Rule 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Period_ESTest_scaffolding_EvoSuite.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.format.DateTimeParser", false, Period_ESTest_scaffolding_EvoSuite.class.getClassLoader()));
    mock(Class.forName("org.joda.time.format.DateTimePrinter", false, Period_ESTest_scaffolding_EvoSuite.class.getClassLoader()));
    mock(Class.forName("org.joda.time.format.PeriodParser", false, Period_ESTest_scaffolding_EvoSuite.class.getClassLoader()));
    mock(Class.forName("org.joda.time.format.PeriodPrinter", false, Period_ESTest_scaffolding_EvoSuite.class.getClassLoader()));
  }
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Period_ESTest_scaffolding_EvoSuite.class.getClassLoader()); 
