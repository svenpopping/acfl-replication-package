...
public class BaseChronology_ESTest_scaffolding_EvoSuite {
  @org.junit.Rule 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BaseChronology_ESTest_scaffolding_EvoSuite.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.format.DateTimeParser", false, BaseChronology_ESTest_scaffolding_EvoSuite.class.getClassLoader()));
    mock(Class.forName("org.joda.time.format.DateTimePrinter", false, BaseChronology_ESTest_scaffolding_EvoSuite.class.getClassLoader()));
    mock(Class.forName("org.joda.time.format.PeriodParser", false, BaseChronology_ESTest_scaffolding_EvoSuite.class.getClassLoader()));
    mock(Class.forName("org.joda.time.format.PeriodPrinter", false, BaseChronology_ESTest_scaffolding_EvoSuite.class.getClassLoader()));
  }
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BaseChronology_ESTest_scaffolding_EvoSuite.class.getClassLoader()); 
