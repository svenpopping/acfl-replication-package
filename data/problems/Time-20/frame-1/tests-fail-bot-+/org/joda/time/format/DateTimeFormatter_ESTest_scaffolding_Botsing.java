...
public class DateTimeFormatter_ESTest_scaffolding_Botsing {
  @org.junit.Rule 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DateTimeFormatter_ESTest_scaffolding_Botsing.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.format.DateTimeParser", false, DateTimeFormatter_ESTest_scaffolding_Botsing.class.getClassLoader()));
    mock(Class.forName("org.joda.time.format.DateTimePrinter", false, DateTimeFormatter_ESTest_scaffolding_Botsing.class.getClassLoader()));
  }
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DateTimeFormatter_ESTest_scaffolding_Botsing.class.getClassLoader()); 
