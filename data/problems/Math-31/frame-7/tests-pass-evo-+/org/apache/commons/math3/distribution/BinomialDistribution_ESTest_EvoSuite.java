...
public class BinomialDistribution_ESTest_EvoSuite extends BinomialDistribution_ESTest_scaffolding_EvoSuite {
  ...
  public void test00()  throws Throwable  {
      BinomialDistribution binomialDistribution0 = new BinomialDistribution(3436, 0.0);
      binomialDistribution0.solveInverseCumulativeProbability((-1.0), (-568), 3436);
      assertEquals(0.0, binomialDistribution0.getProbabilityOfSuccess(), 0.01);
      assertEquals(3436, binomialDistribution0.getNumberOfTrials());
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      BinomialDistribution binomialDistribution0 = new BinomialDistribution(0, 0);
      double double0 = binomialDistribution0.cumulativeProbability(0, 1151);
  ...
  public void test02()  throws Throwable  {
      BinomialDistribution binomialDistribution0 = new BinomialDistribution(1, 1.5069412868172555E-236);
      double double0 = binomialDistribution0.probability(0);
      assertEquals(1.0, double0, 0.01);
      assertEquals(1.5069412868172555E-236, binomialDistribution0.getNumericalVariance(), 0.01);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      assertEquals(1.5069412868172555E-236, double0, 0.01);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      assertEquals(1, int0);
      assertEquals(1.5069412868172555E-236, binomialDistribution0.getProbabilityOfSuccess(), 0.01);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      BinomialDistribution binomialDistribution0 = new BinomialDistribution(1976, 0.0);
      int int0 = binomialDistribution0.getSupportUpperBound();
      assertEquals(0, int0);
      assertEquals(1976, binomialDistribution0.getNumberOfTrials());
  ...
  public void test17()  throws Throwable  {
      BinomialDistribution binomialDistribution0 = new BinomialDistribution(0, 0);
      double double0 = binomialDistribution0.probability(904);
      assertEquals(0.0, binomialDistribution0.getProbabilityOfSuccess(), 0.01);
      assertEquals(0, binomialDistribution0.getNumberOfTrials());
      assertEquals(0.0, double0, 0.01);
  }
