...
public class ChartFactory_ESTest_scaffolding_Botsing {
  @org.junit.Rule 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ChartFactory_ESTest_scaffolding_Botsing.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.sql.Connection", false, ChartFactory_ESTest_scaffolding_Botsing.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.PlotOrientation", false, ChartFactory_ESTest_scaffolding_Botsing.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.gantt.TaskSeriesCollection", false, ChartFactory_ESTest_scaffolding_Botsing.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.general.PieDataset", false, ChartFactory_ESTest_scaffolding_Botsing.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.general.WaferMapDataset", false, ChartFactory_ESTest_scaffolding_Botsing.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.xy.XYDataset", false, ChartFactory_ESTest_scaffolding_Botsing.class.getClassLoader()));
  }
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ChartFactory_ESTest_scaffolding_Botsing.class.getClassLoader()); 
